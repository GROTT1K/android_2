...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    void createSpinner(){
        ...
        spinnerArrayList.add("xinkalushi");
        spinnerArrayList.add("sup");
        spinnerArrayList.add("kotleti");
    ...
    void createMap(){
        ...
        goodsMap.put("xinkalushi", 300.0);
        goodsMap.put("sup", 100.0);
        goodsMap.put("kotleti", 150.0);
    }
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        switch (goodsName) {
            case "xinkali":
                goodsImageView.setImageResource(R.drawable.hinkali);
                break;
            case "sup":
                goodsImageView.setImageResource(R.drawable.sup);
                break;
            case "kotleti":
                goodsImageView.setImageResource(R.drawable.kotleti);
                break;
            default:
                goodsImageView.setImageResource(R.drawable.hinkali);
                break;
